...
extern "C" {
  ...
  EXPORT ALEInterface *ALE_new() {return new ALEInterface();}
  ...
  EXPORT void getAvailableModes(ALEInterface *ale,int *availableModes) {
  ...
  EXPORT int getAvailableModesSize(ALEInterface *ale) {return ale->getAvailableModes().size();}
  EXPORT void setMode(ALEInterface *ale, int mode) {ale->setMode(mode);}
  EXPORT void getAvailableDifficulties(ALEInterface *ale,int *availableDifficulties) {
  ...
  EXPORT int getAvailableDifficultiesSize(ALEInterface *ale) {return ale->getAvailableDifficulties().size();}
  EXPORT void setDifficulty(ALEInterface *ale, int difficulty) {ale->setDifficulty(difficulty);}
  ...
  EXPORT void setLoggerMode(int mode) { ale::Logger::setMode(ale::Logger::mode(mode)); }
}
